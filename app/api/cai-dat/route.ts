...
const VALID_KEYS = [
  ...
  'hoadon_gioiThieu','hoadon_mangXH','hoadon_chanTrang','hoadon_ghiChuHoaDon',
  'hoadon_logo','hoadon_logoSize','hoadon_logoPart','hoadon_mauChinh',
  'hoadon_paddingTrang','hoadon_coChuBang','hoadon_coChuND','hoadon_canChanTrang',
]
...
const MO_TA: Record<string,string> = {
  ...
  hoadon_chanTrang:'Chân trang', hoadon_ghiChuHoaDon:'Ghi chú hóa đơn',
  hoadon_logo:'Logo (base64)', hoadon_logoSize:'Kích thước logo',
  hoadon_logoPart:'Vị trí logo', hoadon_mauChinh:'Màu chủ đạo',
  hoadon_paddingTrang:'Padding trang', hoadon_coChuBang:'Cỡ chữ bảng',
  hoadon_coChuND:'Cỡ chữ nội dung', hoadon_canChanTrang:'Căn chân trang',
}
