// app/dashboard/don-hang/[maDon]/sua/page.tsx
  ...
  return (
    <TaoDonHangForm
      ...
      donHangSua={{
        ...
        tienMat: Number(donHang['Cọc tiền mặt']||0) || (!(donHang['Hình thức cọc']||'').includes('CK') ? Number(donHang['Đặt cọc']||0) : 0),
        ckCoc: Number(donHang['Cọc chuyển khoản']||0),
