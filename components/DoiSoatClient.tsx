'use client'
// components/DoiSoatClient.tsx -- v2.1 simplified
  ...
  return (
    <div style={{padding:'20px'}}>
      <style>{`
        ...
        .modal-ds{background:white;border-radius:12px;padding:24px;width:100%;max-width:480px;max-height:92vh;overflow-y:auto;}
            ...
            <div style={{display:'flex',flexDirection:'column',gap:'12px'}}>
              ...
              <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'10px'}}>
                ...
                <div>
                  ...
                  <input className="input" placeholder="Ghi chú..." value={ghiChu}
